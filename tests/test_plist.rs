...
#[test]
fn test_fapl_driver_sec2() -> h5::Result<()> {
...
#[test]
fn test_fapl_driver_stdio() -> h5::Result<()> {
    let mut b = FileAccess::build();
    b.stdio();
...
#[test]
fn test_fapl_driver_log() -> h5::Result<()> {
    let mut b = FileAccess::build();
...
#[test]
fn test_fapl_driver_core() -> h5::Result<()> {
    let mut b = FileAccess::build();
...
#[test]
fn test_fapl_driver_family() -> h5::Result<()> {
    let mut b = FileAccess::build();
...
#[test]
fn test_fapl_driver_multi() -> h5::Result<()> {
    let mut b = FileAccess::build();
...
#[test]
fn test_fapl_driver_split() -> h5::Result<()> {
    let mut b = FileAccess::build();
...
#[test]
#[cfg(feature = "mpio")]
fn test_fapl_driver_mpio() -> h5::Result<()> {
...
#[test]
#[cfg(h5_have_direct)]
fn test_fapl_driver_direct() -> h5::Result<()> {
    let mut b = FileAccess::build();
...
#[test]
fn test_fapl_set_alignment() -> h5::Result<()> {
...
#[test]
fn test_fapl_set_fclose_degree() -> h5::Result<()> {
...
#[test]
fn test_fapl_set_chunk_cache() -> h5::Result<()> {
...
#[test]
fn test_fapl_set_meta_block_size() -> h5::Result<()> {
...
#[test]
fn test_fapl_set_sieve_buf_size() -> h5::Result<()> {
...
#[test]
fn test_fapl_set_gc_references() -> h5::Result<()> {
...
#[test]
fn test_fapl_set_small_data_block_size() -> h5::Result<()> {
...
#[test]
fn test_fapl_set_mdc_config() -> h5::Result<()> {
...
#[test]
#[cfg(hdf5_1_8_7)]
fn test_fapl_set_elink_file_cache_size() -> h5::Result<()> {
...
#[test]
#[cfg(hdf5_1_10_0)]
fn test_fapl_set_metadata_read_attempts() -> h5::Result<()> {
...
#[test]
#[cfg(hdf5_1_10_0)]
fn test_fapl_set_mdc_log_options() -> h5::Result<()> {
...
fn test_fapl_set_all_coll_metadata_ops() -> h5::Result<()> {
...
#[test]
#[cfg(all(hdf5_1_10_0, feature = "mpio"))]
fn test_fapl_set_coll_metadata_write() -> h5::Result<()> {
...
#[test]
#[cfg(hdf5_1_10_1)]
fn test_fapl_set_page_buffer_size() -> h5::Result<()> {
...
fn test_fapl_set_evict_on_close() -> h5::Result<()> {
...
#[test]
#[cfg(hdf5_1_10_1)]
fn test_fapl_set_mdc_image_config() -> h5::Result<()> {
