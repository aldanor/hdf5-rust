...
register_hid_h5open!(H5P_CLS_ROOT_ID,             H5P_CLS_ROOT_ID_g);
register_hid_h5open!(H5P_CLS_OBJECT_CREATE_ID,    H5P_CLS_OBJECT_CREATE_ID_g);
register_hid_h5open!(H5P_CLS_FILE_CREATE_ID,      H5P_CLS_FILE_CREATE_ID_g);
register_hid_h5open!(H5P_CLS_FILE_ACCESS_ID,      H5P_CLS_FILE_ACCESS_ID_g);
register_hid_h5open!(H5P_CLS_DATASET_CREATE_ID,   H5P_CLS_DATASET_CREATE_ID_g);
register_hid_h5open!(H5P_CLS_DATASET_ACCESS_ID,   H5P_CLS_DATASET_ACCESS_ID_g);
register_hid_h5open!(H5P_CLS_DATASET_XFER_ID,     H5P_CLS_DATASET_XFER_ID_g);
register_hid_h5open!(H5P_CLS_FILE_MOUNT_ID,       H5P_CLS_FILE_MOUNT_ID_g);
register_hid_h5open!(H5P_CLS_GROUP_CREATE_ID,     H5P_CLS_GROUP_CREATE_ID_g);
register_hid_h5open!(H5P_CLS_GROUP_ACCESS_ID,     H5P_CLS_GROUP_ACCESS_ID_g);
register_hid_h5open!(H5P_CLS_DATATYPE_CREATE_ID,  H5P_CLS_DATATYPE_CREATE_ID_g);
register_hid_h5open!(H5P_CLS_DATATYPE_ACCESS_ID,  H5P_CLS_DATATYPE_ACCESS_ID_g);
register_hid_h5open!(H5P_CLS_STRING_CREATE_ID,    H5P_CLS_STRING_CREATE_ID_g);
register_hid_h5open!(H5P_CLS_ATTRIBUTE_CREATE_ID, H5P_CLS_ATTRIBUTE_CREATE_ID_g);
register_hid_h5open!(H5P_CLS_OBJECT_COPY_ID,      H5P_CLS_OBJECT_COPY_ID_g);
register_hid_h5open!(H5P_CLS_LINK_CREATE_ID,      H5P_CLS_LINK_CREATE_ID_g);
register_hid_h5open!(H5P_CLS_LINK_ACCESS_ID,      H5P_CLS_LINK_ACCESS_ID_g);
register_hid_h5open!(H5P_LST_FILE_CREATE_ID,      H5P_LST_FILE_CREATE_ID_g);
register_hid_h5open!(H5P_LST_FILE_ACCESS_ID,      H5P_LST_FILE_ACCESS_ID_g);
register_hid_h5open!(H5P_LST_DATASET_CREATE_ID,   H5P_LST_DATASET_CREATE_ID_g);
register_hid_h5open!(H5P_LST_DATASET_ACCESS_ID,   H5P_LST_DATASET_ACCESS_ID_g);
register_hid_h5open!(H5P_LST_DATASET_XFER_ID,     H5P_LST_DATASET_XFER_ID_g);
register_hid_h5open!(H5P_LST_FILE_MOUNT_ID,       H5P_LST_FILE_MOUNT_ID_g);
register_hid_h5open!(H5P_LST_GROUP_CREATE_ID,     H5P_LST_GROUP_CREATE_ID_g);
register_hid_h5open!(H5P_LST_GROUP_ACCESS_ID,     H5P_LST_GROUP_ACCESS_ID_g);
register_hid_h5open!(H5P_LST_DATATYPE_CREATE_ID,  H5P_LST_DATATYPE_CREATE_ID_g);
register_hid_h5open!(H5P_LST_DATATYPE_ACCESS_ID,  H5P_LST_DATATYPE_ACCESS_ID_g);
register_hid_h5open!(H5P_LST_ATTRIBUTE_CREATE_ID, H5P_LST_ATTRIBUTE_CREATE_ID_g);
register_hid_h5open!(H5P_LST_OBJECT_COPY_ID,      H5P_LST_OBJECT_COPY_ID_g);
register_hid_h5open!(H5P_LST_LINK_CREATE_ID,      H5P_LST_LINK_CREATE_ID_g);
register_hid_h5open!(H5P_LST_LINK_ACCESS_ID,      H5P_LST_LINK_ACCESS_ID_g);
